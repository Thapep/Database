...
-- Πεμ 30 Μαΐ 2019 08:26:51 μμ EEST
...
CREATE TABLE IF NOT EXISTS `mydb`.`borrows` (
  ...
  `copies_copyNr` INT NOT NULL,
  `date_of_borrowing` DATE NOT NULL,
  `date_of_return` DATE NOT NULL,
  PRIMARY KEY (`copies_copyNr`, `date_of_borrowing`, `copies_ISBN`, `member_memberID`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`reminder` (
  ...
  CONSTRAINT `fk_reminder_5`
    ...
    REFERENCES `mydb`.`borrows` (`member_memberID` , `copies_ISBN` , `copies_copyNr` , `date_of_borrowing`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
