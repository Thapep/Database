...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`oldest_books_10` (`ISBN` INT, `title` INT, `AFirst` INT, `ALast` INT, `pubYear` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`all_books` (`ISBN` INT, `'Title'` INT, `'Publication Year'` INT, `'Publisher'` INT);
